            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link rel="noopener noreferrer" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <NavLink to={'/'} className="btn btn-ghost normal-case text-xl font-bold"><span className='bg-blue-500 px-5 py-2 rounded-lg text-white font-bold'>Car Resale</span>.com</NavLink>
                    </Link>
                </div>
